...
try:
    ...
    from .math.patterns import _EquFuncs, _EquPatterns
    from .summary.summary import Summary
    from .constants.constants import CST, Warns, Errs
